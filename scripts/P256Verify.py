...
def main():
    for i in range(1, 1000):
        ...
        if len(hex(public_key_y + 0xffffffff00000001000000000000000000000000ffffffffffffffffffffffff)) == 66:
            print(hex(z))
            print(hex(r))
            print(hex(s))
            print(hex(public_key_x))
            print(hex(public_key_y))
            print(hex(public_key_y + 0xffffffff00000001000000000000000000000000ffffffffffffffffffffffff))
