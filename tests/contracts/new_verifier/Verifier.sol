...
contract Verifier is IVerifier {
    ...
    function log_gas() internal view {
        assembly {
            ...
            mstore(add(freeMemPointer, 0x20), gas())
    ...
    function verify(
        ...
        assembly {
            ...
            function pointMulAndAddIntoDest(point, s, dest) {
                ...
                if iszero(success) {
                    revertWithMessage(22, "pointMulAndAddIntoDest: ECMUL")
                }
                ...
                if iszero(success) {
                    revertWithMessage(22, "pointMulAndAddIntoDest: ECADD")
                }
            }
