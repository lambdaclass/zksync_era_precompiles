...
pub fn write_modexp_gas_result(used_gas: u32) {
    write_line_to_report(used_gas, "gas_reports/modexp_report.csv");
}

pub fn write_ecadd_gas_result(used_gas: u32) {
    write_line_to_report(used_gas, "gas_reports/ecadd_report.csv");
}

pub fn write_ecmul_gas_result(used_gas: u32) {
    write_line_to_report(used_gas, "gas_reports/ecmul_report.csv");
}

pub fn write_ecpairing_gas_result(used_gas: u32) {
    write_line_to_report(used_gas, "gas_reports/ecpairing_report.csv");
}

pub fn write_p256verify_gas_result(used_gas: u32) {
    write_line_to_report(used_gas, "gas_reports/p256verify_report.csv");
}

pub fn write_secp256k1verify_gas_result(used_gas: u32) {
    write_line_to_report(used_gas, "gas_reports/secp256k1verify_report.csv");
}
